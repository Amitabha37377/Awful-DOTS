...
local WIDGET_DIR = HOME .. '/.config/awesome/deco/battery-widget'

local battery_widget = {}
local function worker(user_args)
    local args = user_args or {}

    local font = args.font or 'CaskaydiaCove Nerd Font 10'
    local path_to_icons = HOME .. '/.icons/Arc/status/symbolic/'
    ...
    local timeout = args.timeout or 14
