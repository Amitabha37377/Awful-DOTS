...
theme.bg                                              = color.bg_dim
theme.bg_normal                                       = color.bg_dim
...
--Ontop button
theme.titlebar_ontop_button_normal_inactive           = titlebar_path .. "inactive.png"
theme.titlebar_ontop_button_focus_inactive            = titlebar_path .. "ontop.png"
theme.titlebar_ontop_button_normal_active             = titlebar_path .. "inactive.png"
theme.titlebar_ontop_button_focus_active              = titlebar_path .. "ontop2.png"
theme.titlebar_ontop_button_normal_inactive_hover     = titlebar_path .. "ontop.png"
theme.titlebar_ontop_button_focus_inactive_hover      = titlebar_path .. "ontop.png"
theme.titlebar_ontop_button_normal_active_hover       = titlebar_path .. "ontop2.png"
theme.titlebar_ontop_button_focus_active_hover        = titlebar_path .. "ontop2.png"


--Colors
theme.titlebar_bg                           = color.bg_dim
theme.titlebar_bg_focus                     = color.bg_dim
...
theme.taglist_font                          = user.font .. "12 bold"
